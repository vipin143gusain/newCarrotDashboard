...
const TaskSearch = (
  ...
  const [feedDefault, setFeedDefault] = useState({
    ...
    defaultValues: {
      ...
      text: 'jhgfdd',
      description: 'gfd',
      weblink_url: 'https://staging.futurepay.co.in/#/carrot/view',
      media_type: 'image',
      media_file: 'category/images/2828cb1e-889c-452a-b23b-8426113bfb8e.png',
      display_order: 1,
      category_ids: [42],
      category_ids_with_name: '42#Women',
      sub_category_ids: [51],
      sub_category_ids_with_name: '51#Super Food ',
      theme_ids: [1],
      theme_ids_with_name: '1#theme1',
      tag_ids: [1],
      tag_ids_with_name: '1#tag1',
